public class Main {
    public static void main(String[] args) {
        ...
        Game g1 = new Game("Minecraft", 2009, Game.GameGenre.SANDBOX, Game.GamePlatform.PC, "Minecraft is a game made up of blocks, creatures, and community. You can survive the night or build a work of art – the choice is all yours.", 2.99);
